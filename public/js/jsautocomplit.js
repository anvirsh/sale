    ...
    input.addEventListener('input', () => {
      ...
      if(value.length > 1){//Если набрали уже больше одной буквы
         data.forEach((dataItem, index) => {
          ...
          item.addEventListener('click', function() {
            ...
            findCategor(item.innerText); // вызываем фунцию в виде spravochniks/categors/indexajax.blade.php
          });
     ...
     input.addEventListener('keydown', e => {
      ...
      if(keyCode === 40) { // arrow down
        ...
        findCategor(input.value); // вызываем фунцию в виде spravochniks/categors/indexajax.blade.php
