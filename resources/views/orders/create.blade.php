...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href='{{ route("orders")}}'> << </a>  {{ __('Создание  заказа') }}
        </h2>
    </x-slot> 
  ...
  <div class="tabs">
    ...
    <div class="tabs__content">
      <div class="tabs__pane tabs__pane_show" id="content-1">
		 <div class="py-12">
 	        <form id="formOrder" enctype="multipart/form-data" method="POST"  action="{{route('orders.store')}}">
	           {{csrf_field()}}
			   <span>&nbsp;&nbsp;&nbsp;&nbsp; Дата </span>&nbsp;&nbsp;<input type="text" name="date" value="{{old('date')}}"  >&nbsp;&nbsp; &nbsp;&nbsp; </br> </br>
			   <span> Телефон </span><input type="text" name="phone" value="{{old('phone')}}" >&nbsp;&nbsp; &nbsp; </br> </br>  
               <span>&nbsp;&nbsp;&nbsp; Email &nbsp; </span>  <input type="text" name="email" value="{{old('email')}}"  > &nbsp;&nbsp; &nbsp; </br> </br>    			  
			   <input type="hidden"  value="{{old('total')}}"  id="totalOrder"  name="total" > <!-- в js вложен. part.tab_products считаем сумму сюда -->
               <input type="hidden"  value="{{old('prod_ids')}}"  id="prodID"  name="prod_ids" >			   
		   </form>			 
        </div> 
      </div>
	...
	<div class="row">
      <div class="col-md-12" ><!-- этот заполняем на js во вложенном в табе товары -->
       <h6>  &nbsp; &nbsp;&nbsp; Сумма заказа ___ <span id="summaDockumenta"> 00  (руб.)</span> &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;            
