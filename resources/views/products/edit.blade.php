<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href='{{ route("products")}}'> << </a>  {{ __('Редактирование  товара') }} . . . {{ $product->name }}
        </h2>
    </x-slot> 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
               <div class="p-6 text-gray-900"> 
 	           <form id="formNomnklt" enctype="multipart/form-data" method="POST"  action="{{route('products.update', $product->id)}}">
	           {{csrf_field()}}
                 <input type="text" name="name" value="{{ $product->name }}"  > &nbsp;&nbsp; &nbsp; <span> Наименование </span> </br> </br>
				 <input type="text" name="price" value="{{ $product->price }}" > <span> &nbsp;&nbsp; &nbsp; Цена  </span>  </br> </br>
